...
void manually_capture_image_and_send_to_server(String img_params)
{
  ...
  if (DEBUG)
  {
    Serial.print("img_params: ");
    Serial.println(img_params);
  }
  ...
  if (DEBUG)
  {
    Serial.print("requested_frame_size: ");
    Serial.println(requested_frame_size);
    Serial.print("requested_jpeg_quality: ");
    Serial.println(requested_jpeg_quality);
    Serial.print("requested_extra_flash: ");
    Serial.println(requested_extra_flash);
  }
  // ----------------------------------------------------------------------------------------------------
  ...
  {
    if (DEBUG)
      Serial.println("Photo Captured in 'fb' Buffer!");
  }
  else
  {
    if (DEBUG)
  ...
  {
    if (DEBUG)
      Serial.println("Telling Server to Save Images and\nWaiting for response...");
    // ----------------------------------------------------------------------------------------------------
    if (sendFlagToServerAndWaitForReply("CaPpIcStrt"))
    {
      if (DEBUG)
        Serial.println("Server successfully informed for 'CaPpIcStrt'");
    }
    // ----------------------------------------------------------------------------------------------------
    ...
    if (DEBUG)      
      Serial.println("FULL Image Sent!\nfb Global Buffer CLEARED");
  }
}
// ***********************************************************************************************
