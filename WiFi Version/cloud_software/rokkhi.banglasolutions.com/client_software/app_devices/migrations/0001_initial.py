    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dev_alert_cause', models.CharField(choices=[('motion', 'Motion'), ('person', 'Person'), ('m_or_p', 'Motion Or Person'), ('m_and_p', 'Motion & Person')], default='m_or_p', max_length=30, verbose_name='Alert Cause')),
